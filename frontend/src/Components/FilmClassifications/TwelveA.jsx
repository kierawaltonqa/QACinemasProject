...
const TwelveA = ({ toggleShow12A }) => {
  ...
  return (
    <>
      ...
      <>
        ...
        <div className="beauty">
          ...
          <Toast.Body className="goldenHours">
            ...
            <hr />
            <strong style={{ color: "red" }}>12A Cinema release suitable for 12 years and older</strong>
            <p style={{ color: "red" }}>Films classified 12A and video works classified 12 contain material that is not generally suitable for children aged under 12.
      ...
      No one younger than 12 may rent or buy a 12 rated video work.</p>
